<template>
    <header class="header">
        <div class="container">
            ...
            <button @click="ShowCart" class="cart-item-button" v-if="$route.meta.showCart">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="54" height="54" viewBox="0 0 16 16">
                    <path fill="#ffffff"
            ...
            <form class="dropdown__search">
                <button class="cart-item-button" v-if="$route.meta.showSearch">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="54" height="54" viewBox="0 0 396.819 396.819"
            ...
            <Cart v-if="$store.state.cart.length" :cart_data="$store.state.cart" v-show="show" />
        </div>
    </header>
</template>
<script>
