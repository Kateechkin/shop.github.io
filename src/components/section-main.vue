  ...
  <div class="section-wrap">
    <div class="select-container">
      <section class="section-main">
        <div class="section-gradient containers">
          ...
          <div class="section-main__wrap">
            ...
            <div class="section-main__block">
              ...
              <p class="block__text">
                Компания заботится о своей репутации и постоянно работает над
                улучшением качества обслуживания.
              </p>
            </div>
          </div>
        </div>
        <div class="section-body__gradient">
          <div class="section-body containers">
            ...
            <div class="section-body__block">
              ...
              <p class="section-body__text">
                Мы согласовываем заказ и рассчитываем стоимость
              </p>
            </div>
            <div class="section-body__block">
